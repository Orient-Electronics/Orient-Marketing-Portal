...
var App = function() {
  ...
  var handleSidebar = function(mode, extra) {
    if (mode === 'init') {
      ...
      $('.sidebar-partial #sidebar').mouseenter(function(){ handleSidebar('close-sidebar-alt'); });
      $('.sidebar-alt-partial #sidebar-alt').mouseenter(function(){ handleSidebar('close-sidebar'); });
    } 
    else {
      ...
      $('a', colorList).click(function(e){
          ...
          if (theme === 'default') {
              ...
              if (themeLink.length) {
                  ...
                  console.log(theme);
                  $('link[href="/assets/themes.css?body=1"]').before('<link id="theme-link" rel="stylesheet" href="' + theme + '">');
                  themeLink = $('#theme-link');
              }
          }
      });
