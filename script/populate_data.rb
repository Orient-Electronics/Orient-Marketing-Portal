...
2.upto(oo.last_row) do |line|
  ...
  shop.address    = oo.cell(line,'E')
  shop.phone    = oo.cell(line,'F')
  shop.website    = oo.cell(line,'G')
  shop.email    = oo.cell(line,'H')
  location.latitude    = oo.cell(line,'I')
  location.longitude    = oo.cell(line,'J')
  owner.name    = oo.cell(line,'K')
  owner.cell_number    = oo.cell(line,'L')
  owner.dob    = oo.cell(line,'M')
  manager.name    = oo.cell(line,'N')
